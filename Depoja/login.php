			...
			<div class="container">
				  <form method="post" action="index.php">
			       <?php include('errors.php'); ?>
					...
					<input type="text" placeholder="Shkruani emrin" name="emri" id="emri" onfocus="this.value=''" value="<?php echo $emri;?>" required />
					...
					<input type="password" placeholder="Perseriteni fjalëkalimin" name="password_2" id="t5" class="tb" required  />-->
...
<script>
	...
	//	var uname = document.getElementById("t3").value;
		...
		if (name == '') {
			...
			document.getElementById("emri").style.color = "black"
			...
			document.getElementById("emri").value = placeholder = "";
