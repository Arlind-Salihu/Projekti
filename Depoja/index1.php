...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="#">KRAR App</a>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
		  ...
		  <li class="nav-item">
          <a class="nav-link" href="http://localhost/registration/regjistrimi/uploads/index.php">Shkarko foto</a>
        </li>
      </ul>
    </div>
      ...
      <div class="col-md-4">
        ...
        <form action="action.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="text" name="name" value="<?= $name; ?>" class="form-control" placeholder="Shkruaje emrin" required>
          </div>
          <div class="form-group">
            <input type="code" name="code" value="<?= $code; ?>" class="form-control" placeholder="Shkruaje kodin" required>
          </div>
		  <div class="form-group">
            <input type="price" name="price" value="<?= $price; ?>" class="form-control" placeholder="Shkruaje qmimin" required>
          </div>
		  <div class="form-group">
            <input type="sasia" name="sasia" value="<?= $price; ?>" class="form-control" placeholder="Shkruaje sasin" required>
          </div>
          <div class="form-group">
