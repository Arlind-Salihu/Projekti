...
<body>
	...
	<div class="topnav">
		<a class="active" href="../html/Home.html"><i class="fa fa-fw fa-home"></i> Ballina</a>
		<a href="../html/Produktet.html"><i class=" fa fa-institution"></i> Produktet</a>
	...
	<div id="statik">
		<div class="row">
		  <div class="column2" >	
                ...
                <img class="fotomySlides" src="../foto/laptop.png" alt="laptop" style="width:370px" style="height: 20px;"><p id="pteksti"><b>Laptop Dell</b></br></br>
                    Kodi i produktit:267647</br>
                    Bateri: 4-qelizore, 68Wh</br>
                    Prodhuesi: Dell</br>
                    Lloji i SSD: M.2 PCIe (slot)</br>
                    Memorie e brendshme GB: 256</br>
                    Modeli i procesorit: 8265U(1.6/3.9GHz 4 bërthama / 8 threads)</br></br>
                    <b>Çmimi: 750.00 €</b></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 copyright">
						<p>UBT© <a href="https://www.ubt-uni.net/sq/ballina/">UBT - Web Page</a>. All Rights Reserved
						</p>
					</div>
				</div>
			</div>
